...
# Universal execution policy handler - works with PS5.1 and PS7
$currentPolicy = Get-ExecutionPolicy
if ($currentPolicy -match 'Restricted|AllSigned') {
    # Detect current PowerShell edition and relaunch with same binary
...
Write-Host "    2. Run  nanobot-agent.ps1  or  nanobot-gateway.ps1"
Write-Host ""
